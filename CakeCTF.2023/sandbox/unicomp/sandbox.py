...
def emu_syscall(mu, _user_data):
    print('executing syscall: '+str(mu.reg_read(UC_X86_REG_RAX)))
    print('rdi = '+str(mu.reg_read(UC_X86_REG_RDI)))
    print('rsi = '+str(mu.reg_read(UC_X86_REG_RSI)))
    print('rdx = '+str(mu.reg_read(UC_X86_REG_RDX)))
    ret = libc.syscall(
    ...
    print('return value-> '+str(mu.reg_read(UC_X86_REG_RAX)))
